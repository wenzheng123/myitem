  ...
  <div class="glass">
    <div class="preview">
      ...
      <div id="vertical" class="bigImg">
        ...
        <img src="static/img/mid/05.jpg" width="500" height="277" alt="" id="midimg" />
      ...
      <div id="bigView" style="display:none;"><img width="500" height="277" alt="" src="" /></div>
...
<style scoped>
  ...
  #imageMenu {height:50px; width:440px; overflow:hidden; margin-left:0; float:left;margin-top: 20px;}

  #imageMenu li {height:50px; width:100px; overflow:hidden; float:left; text-align:center;margin-left: 8px;}

  #imageMenu li img{width:90px; height:50px;cursor:pointer;}

  #imageMenu li#onlickImg img, #imageMenu li:hover img{ width:84px; height:44px; border:3px solid #959595;}

  /* bigImg */

  .bigImg{position:relative; float:left; width:500px; height:277px; overflow:hidden;}

  .bigImg #midimg{width:500px; height:277px;}
